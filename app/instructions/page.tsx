      ...
      <div>
        ...
        <Typography level="body-lg">
          ...
          <ol>
            ...
            <li>
              The questions Answered and Marked for Review will be considered
              for evalution.
              <br />
            </li>
          </ol>
        ...
        <Typography level="body-lg">
          ...
          <br />
          b. Click on Save & Next to save your answer for the current question
        ...
        <Typography level="body-lg">
          ...
          <br />
          11. After click the Save & Next button on the last question for a
          section, you will automatically be taken to the first question of the
          next section.
          <br />
          12. You can shuffle between sections and questions anything during the
          examination as per your convenience only during the time stipulated.
          <br />
          13. Candidate can view the corresponding section summery as part of
        ...
        <Divider sx={{ m: 2 }} />
        <Typography level="body-lg">
          <Checkbox defaultChecked /> I have read and understood the
          instructions. All computer hardware allotted to me are in proper
          working condition. I declare that I am not in possession of / not
          wearing / not carrying any prohibited gadget like mobile phone,
          bluetooth devices etc. /any prohibited material with me into the
